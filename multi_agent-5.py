...
def interactive_loop(agent_cfgs, orch_cfg, mode):
    print(header("Multi-Agent Orchestrator  v5"))
    print_status(agent_cfgs, orch_cfg, mode)
...
Starting:
  python3 multi_agent-5.py
  python3 multi_agent-5.py --mode code
  python3 multi_agent-5.py --agent groq llama-3.3-70b-versatile --agent mistral mistral-small-latest --agent together meta-llama/Llama-3.3-70B-Instruct-Turbo-Free
...
""")
    ...
    if not any_key:
        ...
        print("  python3 multi_agent-5.py --agent ollama llama3.3 --agent ollama mistral --agent ollama phi4")
        sys.exit(1)
